...
export interface ElectronAPI {
  ...
  // File read/write by absolute path (memory viewer)
  readFileByPath: (absolutePath: string) => Promise<{ success: boolean; content?: string; error?: string }>;
  writeFileByPath: (absolutePath: string, content: string) => Promise<{ success: boolean; error?: string }>;
  getHomeDir: () => Promise<string>;
  getManagedClaudePath: () => Promise<string | null>;
