...
/** Save/write a memory .md file */
export const MEMORY_SAVE_FILE = 'memory:saveFile';

/** Delete a memory .md file */
export const MEMORY_DELETE_FILE = 'memory:deleteFile';

/** Create a new memory .md file */
export const MEMORY_CREATE_FILE = 'memory:createFile';
